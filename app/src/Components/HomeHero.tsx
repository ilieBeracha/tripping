  ...
  return (
    ...
    >
      <div className="w-full h-full justify-center items-center grid grid-cols-2">
        <div className="h-full justify-center flex-col p-32 lg:mx-0 shadow-lg grid grid-rows-2">
          <div className="flex-flex-col justify-center items-center">
            ...
            <p className="mt-2 text-lg leading-8 text-gray-600">
              ...
              retreat, our platform offers personalized travel recommendations
              and expert advice tailored to your preferences.
            </p>
